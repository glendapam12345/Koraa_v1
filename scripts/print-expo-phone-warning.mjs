...
console.log('  Si dice "could not connect", se queda cargando, o Expo Go no abre nada:');
console.log('     • USA: npm run dev:go   (túnel cloudflared + Metro con proxy)');
console.log('     • O HOTSPOT del iPhone → Mac al hotspot → npm run dev:clear');
console.log('     • NO mezcles dev:clear con URLs de túnel viejas');
