...
export const uiEs = {
  ...
  quickOnboarding: {
    ...
    subtitle: 'Tres pasos suaves — sin presión. Así funciona tu día.',
    step1Title: 'Tareas',
    step1Body:
  ...
  koraaGuide: {
    ...
    subtitle:
      'Koraa no es una lista de deberes. Es un ritmo suave: primero sueltas, luego sientes, y al final ves unos pocos pasos para hoy.',
    cta: 'Entendido',
    a11yClose: 'Cerrar guía',
    stepsA11y: 'Tres pasos: Tareas, check-in y pasos sugeridos en Hoy',
    step1Label: 'Paso 1 · Tareas',
    step2Label: 'Paso 2 · Hoy · Check-in',
    step3Label: 'Paso 3 · Hoy · Pasos',
    menuTitle: 'Cómo funciona Koraa',
    menuSubtitle: 'El ritmo: suelta → siente → pocos pasos',
    menuA11y: 'Ver la guía de tres pasos de Koraa',
    menuHint: 'Explica el ritmo diario de Koraa en tres pasos',
    replayCta: 'Ver la guía de nuevo',
    replayA11y: 'Abrir la guía de tres pasos',
  },
  settingsUi: {
    save: 'Guardar',
