...
export const featuresEn = {
  ...
  onboarding: {
    ...
    welcome: {
      ...
      subtitle: 'Four gentle steps to start — no pressure',
      description:
        'Your world, what you repeat, what is pending, and a short check-in. Koraa suggests what matters today — the rest can wait.',
      previewTitle: 'Just a few minutes',
      ...
      quickStart: 'Start setup',
      quickStartHint:
        'Four short steps: areas, activities, capture, and check-in. Skip anything optional.',
      seeHowItWorks: 'See the steps',
      skip: 'Explore without setup',
    },
    intro2: {
    ...
    howItWorks: {
      ...
      subtitle: 'Four steps so Koraa can know you — then the daily rhythm is simple',
      ...
      startCheckIn: 'Start setup',
      enterApp: 'Explore without setup',
      continue: 'Continue',
    },
    setupFlow: {
      ...
      dailyBody:
        'Tasks → check-in → what matters today.\nLow energy: fewer steps. No guilt.',
    },
  },
  hoy: {
    focusSummaryLine:
