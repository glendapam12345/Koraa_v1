...
export const featuresEn = {
  ...
  flow: {
    caption: 'Your day in 4 steps',
    captionSub:
      '1) Capture · 2) Check in · 3) Koraa adapts · 4) Do one step.',
  ...
  vaciar: {
    ...
    liveHeroDetectedAreas:
      '{{areas}} areas · {{tasks}} things — release when ready.',
    liveAreaDetectedTitle: 'How it would group',
    liveAreaGrouping: 'Grouping…',
    liveAreaDetectedOne: '1 thing',
    liveAreaDetectedMany: '{{tasks}} things · {{areas}} areas',
    liveAreaAdjustHint: 'You can adjust everything in the next step.',
    ...
    areaReviewConfirm: 'Done — go to Today',
    areaReviewConfirmCheckIn: 'Done — check-in on Today',
    areaReviewConfirmHint: "We'll save what you sorted and update Today.",
    areaReviewGoTips: 'Or see tips',
    areaReviewGoTipsA11y: 'Save and open tips',
  ...
  semana: {
    ...
    introGlance: 'Pick a day and see what’s there',
    energyDayBadge: '{{word}} energy day',
    stripDayA11y: '{{day}} {{date}}',
    monthToggleShow: 'More dates',
    monthToggleHide: 'Hide dates',
    monthToggleA11y: 'Show or hide more dates in the month',
  ...
  tips: {
    ...
    categoryOptional: 'One is enough. The rest only if you feel like it.',
    categoryVisibleCount: 'You see {{visible}} of {{total}} in this category.',
    categoryPrimaryEyebrow: 'For today',
    howLabel: 'How',
    categoryMoreToggle: 'More tips ({{count}})',
    categoryMoreHide: 'Hide more',
    categoryPremiumHint: '{{count}} more here whenever you want — no rush.',
    categoryPremiumCta: 'See more with Premium',
    actionHeroEyebrow: 'A gentle nudge',
  ...
  onboarding: {
    ...
    checkInProgressA11y: 'Moment {{current}} of {{total}}',
    welcome: {
      brand: 'Koraa',
      title: 'How it works',
      ...
      exampleExhausted: 'If you arrive tired',
      exampleEnergy: 'Energy: {{n}} / 5',
      exampleResultLow: 'Koraa leaves only 2 gentle steps',
      exampleOr: 'or',
      exampleMotivated: 'If you have a little more energy',
      exampleResultHigh: 'It suggests a few more — no pressure',
      exampleLowStep1: 'Reply to one message',
      exampleLowStep2: 'Drink water and pause',
      exampleHighStep1: 'Take one project step',
    ...
    flow: {
      kicker: 'The rhythm',
      lead: 'Capture → Feel → Adapt → One step',
      a11y:
        'Four steps: write what is on your mind, say how you feel, Koraa adapts, do one step.',
      step1Title: 'Capture',
      step1Body: 'Write what is on your mind.',
      step2Title: 'Check in',
      step2Body: 'Say how you feel. Just one minute.',
      step3Title: 'Adapt',
      step3Body: 'Koraa keeps a few steps for today.',
      step4Title: 'One step',
      step4Body: 'Do one. No guilt.',
    ...
    name: {
      title: 'What should I',
      titleAccent: 'call you?',
      subtitle: 'Just your name. That is how Ellie and Koraa greet you.',
      placeholder: 'Your name',
      continue: 'Next',
      saving: 'Saving…',
      continueHint: 'Save your name and continue',
      inputHint: 'Type what you want us to call you',
      invalid: 'Please enter at least 2 letters.',
      saveError: 'Could not save your name. Try again.',
    },
    intro2: {
    ...
    intro3: {
      ...
      step1Title: 'Capture',
      step1Desc: 'Write what you carry',
      step2Title: 'Check in',
      step2Desc: 'Say how you feel (~1 min)',
      step3Title: 'Adapt',
      step3Desc: 'A few steps for today',
      resultTitle: '✨ One step',
      resultBody: 'Do one. No guilt. The rest can wait.',
      continue: 'Continue',
    },
    emotion: {
      title: 'How are you',
      titleAccent: 'feeling',
      subtitle: 'today?',
      checkInHint: 'Tap one. That is how we shape today’s steps.',
      continue: 'Continue',
    },
    energy: {
      title: 'How much',
      titleAccent: 'energy',
      subtitle: 'do you bring?',
      veryLow: 'Very low',
      low: 'Low',
      medium: 'Okay',
      high: 'High',
    ...
    focus: {
      title: 'Today your head',
      titleAccent: 'feels…',
      subtitle: '',
      softHint: 'Not a test — just whether things feel foggy or clear.',
      scattered: 'Very foggy',
      somewhat: 'A bit cloudy',
      normal: 'Okay',
      focused: 'Clear',
    ...
    capture: {
      ...
      subtitle: 'This is the first step. Write one thing on your mind.',
      hintTitle: 'One thing is enough',
      ...
      emptyTitle: 'Add at least one thing',
      emptyBody: 'One line is enough for us to leave you a step on Today.',
      continue: 'Continue',
      skip: 'Skip for now',
      saving: 'Saving...',
      saveError: 'Could not save your tasks. Try again.',
    ...
    howItWorks: {
      title: 'How it',
      titleAccent: 'works',
      subtitle: 'Four short steps. Easy to follow.',
      step1Title: 'Release what is pending',
      step1Body:
        'Open Tasks and write what is on your mind. No sorting required.',
      step2Title: 'Say how you feel',
      step2Body:
        'On Today, one minute: emotion and energy (you can refine time and clarity).',
      step3Title: 'See a few steps',
      step3Body:
        'Koraa suggests 2–5 things based on how you are. The rest can wait.',
      adaptTitle: 'Adapts to you',
      adaptBody:
        'Low energy → fewer, gentler steps\nMore energy → up to 5 — no rush, no guilt',
      startCheckIn: 'Start',
