...
export const featuresEn = {
  ...
  vaciar: {
    ...
    areaReviewSubtitle:
      'Review how things were grouped. Tap a task for date, time, and priority — or to move it. Without a project it stays in the area; need another bucket? Add a new area below.',
    ...
    areaReviewMoveAreaHint: 'Tap the destination area — easier than dragging.',
