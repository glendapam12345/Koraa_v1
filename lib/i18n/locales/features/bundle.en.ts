...
export const featuresEn = {
  ...
  tips: {
    ...
    categoryPrimaryEyebrow: 'One for now',
    categoryMoreToggle: 'More tips ({{count}})',
    categoryMoreHide: 'Hide more',
    categoryPremiumHint: 'Premium unlocks {{count}} more tips here — optional.',
    categoryPremiumCta: 'See Premium',
  ...
  onboarding: {
    ...
    howItWorks: {
      ...
      subtitle: 'A three-beat rhythm — no pressure',
