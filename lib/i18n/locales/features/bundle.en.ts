...
export const featuresEn = {
  ...
  vaciar: {
    ...
    previewDiscoveryTitle: 'I found {{count}} active fronts in your mind',
    previewDiscoveryTitleOne: 'I found 1 active front in your mind',
    previewDiscoverySubtitle:
      'Not a task list — these are the open fronts you are carrying. Koraa only groups and asks what you know.',
    previewChaosRelief:
      'I grouped {{tasks}} things into {{fronts}} fronts. You do not have to carry everything at once.',
    previewChaosReliefOne: 'It is one thing — already clearer.',
    previewClarityNote: 'What matters today comes after check-in on Today — not here.',
    reliefGotIt: 'Got it',
    ...
    previewConfirm: 'Looks good ✨',
    previewBack: 'Back to brain dump',
    previewBackA11y: 'Back to edit brain dump text',
    previewEditTaskA11y: 'Edit {{task}}',
    previewTapToAdjust: 'Adjust project or date if needed',
    ...
    viewProjectsLink: 'See my projects →',
    viewProjectsA11y: 'See my projects',
    capturePrompt: "What's on your mind?",
    captureSubtitle: 'Let it go. Koraa will organize later.',
    ...
    frontsOpen: 'I see {{count}} open fronts.',
    frontsOpenOne: 'I see 1 open front.',
    ...
    segmentCaptureA11y: 'Capture tasks',
    segmentProjectsA11y: 'View areas and projects',
  ...
  semana: {
    ...
    introShort: 'Tap a day. Colors reflect how you felt.',
    prev: 'Previous',
    next: 'Next',
