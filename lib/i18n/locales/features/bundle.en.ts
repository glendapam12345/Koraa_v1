...
export const featuresEn = {
  ...
  flow: {
    ...
    captionSub: 'How you feel → Brain dump → Calendar. Koraa picks your focus in Today.',
    stepTasksHint: 'Brain dump',
    stepFeelHint: 'How you feel',
  ...
  vaciar: {
    ...
    subtitle: 'Write what is on your mind. Below you can pick project and date if you want.',
