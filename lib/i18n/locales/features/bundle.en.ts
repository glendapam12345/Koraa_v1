...
export const featuresEn = {
  ...
  onboarding: {
    ...
    welcome: {
      ...
      subtitle: 'A short check-in (~1 min) and gentle steps for today — no pressure',
      description:
      ...
      quickStart: 'Start',
      quickStartHint: 'Four gentle check-in questions. Then you see your plan on Today.',
      seeHowItWorks: 'See how it works',
      skip: 'Explore without check-in',
    },
    intro2: {
    ...
    setupFlow: {
      ...
      stepFeelTitle: 'How you feel',
      stepFeelBody: 'Emotion, energy, time, and clarity — about 1 minute.',
      stepPlanTitle: 'What matters today',
      stepPlanBody: 'Koraa suggests a few gentle steps. The rest can wait.',
      stepRestTitle: 'The rest, at your pace',
      stepRestBody: 'Areas, capture, and details can wait — no rush.',
