...
export const featuresEn = {
  ...
  onboarding: {
    ...
    welcome: {
      ...
      title: 'How it works',
      titleAccent: 'Koraa',
      subtitle: 'Name → capture → feel → one step. No rush.',
      ...
      quickStart: 'Start',
      quickStartHint: 'Name, capture what is pending, and a short check-in. Then see your step on Today.',
    ...
    energy: {
      ...
      high: 'High',
      veryHigh: 'Very high',
      adaptHint: 'Low energy = fewer steps. No guilt.',
      continue: 'Continue',
    },
    time: {
      title: 'How much',
    ...
    capture: {
      ...
      subtitle: 'Write 1–3 things. Then Ellie shapes your Today.',
      hintTitle: 'No order, no guilt',
      hintBody: 'One line per thing. That is enough to suggest a step.',
