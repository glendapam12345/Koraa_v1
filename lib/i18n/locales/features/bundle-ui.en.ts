...
export const uiEn = {
  ...
  paywallExtra: {
    fallbackMonthlyPrice: '{{price}} / month',
    fallbackAnnualPrice: '{{price}} / year',
  ...
  quickOnboarding: {
    ...
    subtitle: 'Four gentle steps — no pressure. This is how your day works.',
    step1Title: 'Capture',
  ...
  koraaGuide: {
    title: 'How Koraa works',
    subtitle:
      'Capture → feel → Koraa adapts → one step. No endless list. No guilt.',
    cta: 'Got it',
    a11yClose: 'Close guide',
    stepsA11y: 'Four steps: capture, feel, adapt, one step',
    step1Label: 'Step 1 · Capture',
    step2Label: 'Step 2 · Check in',
    step3Label: 'Step 3 · Adapt',
    step4Label: 'Step 4 · One step',
    menuTitle: 'How Koraa works',
    menuSubtitle: 'Capture → feel → adapt → one step',
    menuA11y: 'See Koraa’s four-step guide',
    menuHint: 'Explains Koraa’s daily rhythm in four steps',
    replayCta: 'See the guide again',
    replayA11y: 'Open the four-step guide',
  },
  settingsUi: {
    save: 'Save',
  ...
  onboardingA11y: {
    ...
    skipIntroHint: 'Enter Koraa without the guided setup',
    welcomeSeeHowHint: 'Four setup steps before check-in',
    intro2ContinueHint: 'Next: how Koraa works in three steps',
    howItWorksCheckInHint: 'Start with your areas and follow the guided walkthrough',
    howItWorksContinueHint: 'Enter Koraa without finishing setup',
    ...
    howItWorksStepsGroup: 'Four steps to set up Koraa for the first time',
  ...
  areasCompact: {
    ...
    overdueSectionHint:
      'Steps dated before today. No rush — just so they do not get lost.',
    overdueOne: '{{count}} step',
    overdueMany: '{{count}} steps',
    overdueMeta: 'Overdue · {{date}}',
    overdueShow: 'Show',
    overdueHide: 'Hide',
    overdueShowA11y: 'Show {{count}} overdue steps',
    overdueHideA11y: 'Hide overdue steps',
