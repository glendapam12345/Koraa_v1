...
export const uiEn = {
  ...
  quickOnboarding: {
    ...
    subtitle: 'Three gentle steps — no pressure. This is how your day works.',
    step1Title: 'Tasks',
    step1Body:
  ...
  koraaGuide: {
    ...
    subtitle:
      'Koraa is not a to-do list. It is a soft rhythm: empty first, feel next, then see a few steps for today.',
    cta: 'Got it',
    a11yClose: 'Close guide',
    stepsA11y: 'Three steps: Tasks, check-in, and suggested steps in Today',
    step1Label: 'Step 1 · Tasks',
    step2Label: 'Step 2 · Today · Check-in',
    step3Label: 'Step 3 · Today · Steps',
    menuTitle: 'How Koraa works',
    menuSubtitle: 'Rhythm: empty → feel → few steps',
    menuA11y: 'See Koraa’s three-step guide',
    menuHint: 'Explains Koraa’s daily rhythm in three steps',
    replayCta: 'See the guide again',
    replayA11y: 'Open the three-step guide',
  },
  settingsUi: {
    save: 'Save',
