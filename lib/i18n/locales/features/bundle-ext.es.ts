export const extEs = {
  ...
  deviceCalendar: {
    draftDateHint:
      'Al guardar la tarea, verás «Calendario del teléfono» en cada paso sugerido de Hoy (Google Calendar en Android).',
  },
  googleCalendar: {
  ...
  hoyDayFlow: {
    ...
    reorganizeCta: 'Actualizar cómo me siento',
    ...
    nothingDoneReorganize: 'Actualizar en 1 min',
  ...
  smart: {
    ...
    suggestMid: 'Energía moderada. Lo importante primero, el resto puede esperar.',
  ...
  hoyPlanFallback: {
    ...
    priorityOne: 'Koraa sugiere {{count}} paso para hoy.',
    priorityMany: 'Koraa sugiere {{count}} pasos para hoy.',
  ...
  hoyExtra: {
    ...
    goFeelPrioritize: 'Ir a Hoy para registrar cómo te sientes',
    goFeelPrioritizeHint: 'Haz check-in y Koraa sugerirá qué podría importar hoy',
