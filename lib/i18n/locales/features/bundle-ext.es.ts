export const extEs = {
  ...
  projects: {
    ...
    addHint: 'Captura una tarea y asígnala a un proyecto si quieres.',
    addA11y: 'Agregar tarea, ir a capturar',
    createProjectCta: 'Nuevo proyecto',
    createProjectHint: 'Nombre, color y fecha para terminar',
    createProjectFormHint: 'La fecha del proyecto se ve en Mis proyectos.',
    createProjectA11y: 'Crear un proyecto nuevo',
    addTaskCta: 'Agregar tarea',
    ...
    dueDateLabel: 'Fecha para terminar el proyecto',
    dueDatePlaceholder: 'AAAA-MM-DD',
    dueDateHint: 'Opcional. Ayuda a ver cuánto falta y a sugerir pasos.',
    dueDateA11y: 'Fecha límite del proyecto',
    focusCta: 'Enfocarnos en terminar este proyecto',
