export const extEs = {
  ...
  projects: {
    ...
    organizedTitle: 'Todo organizado',
    organizedSubtitle: 'Expande un proyecto para ver, editar o agregar cosas.',
    organizedSummary: '{{projects}} proyectos · {{tasks}} cosas pendientes.',
    organizedEmptySummary: 'Aún no hay nada guardado.',
    organizedLooseOnly: '{{count}} cosas sueltas, sin proyecto.',
    organizedProjectOne: '1 proyecto',
    organizedProjectMany: '{{count}} proyectos',
    ...
    areaGroupedExplainer:
      'Cada bloque es un área de vida. Dentro van tus proyectos — sin prisa por ordenarlo todo.',
    ...
    focusedBannerGoHoy: 'Ver plan en Hoy',
  ...
  meditation: {
    ...
    breatheQuickSubtitle: 'Inhala, aguanta, suelta — tres veces, a tu ritmo',
    breatheQuickHint: '3 respiraciones · inhala, aguanta, suelta',
    breatheQuickStart: 'Empezar respiro',
    breatheQuickInhale: 'Inhala',
    breatheQuickHold: 'Aguanta',
  ...
  quickRecheck: {
    ...
    errorTimeout: 'Tardó demasiado. Revisa tu conexión e inténtalo otra vez.',
    mockTitle: '¿Cómo te sientes hoy?',
    mockTitleUpdate: '¿Cómo te sientes ahora?',
    mockSubtitle: 'Esto ayuda a Koraa a sugerir un plan suave para hoy.',
    mockSubtitleUpdate: 'Si cambió tu día, ajustamos los pasos con calma.',
    noteLabel: '¿Algo en mente? (opcional)',
    notePlaceholder: 'Una línea, si quieres…',
    noteHint: 'Solo para este momento — aún no se guarda.',
    advancedToggle: 'Tiempo y mente (opcional)',
    continue: 'Continuar',
    continueUpdate: 'Actualizar',
  },
  sentirToday: {
    ...
    quickRecheck: 'Actualizar cómo me siento',
    quickRecheckA11y:
      'Abrir check-in: energía, emoción y opciones opcionales',
  ...
  emergencyKit: {
    ...
    entryEyebrow: 'Cuando lo necesites',
    entryTitle: 'Kit de calma',
    entrySubtitle: 'Un espacio suave si hoy se siente demasiado.',
    entryCta: 'Abrir',
    entryCtaHint: 'Abre tu espacio de apoyo emocional',
    checkInTitle: 'Kit de calma',
    checkInSubtitle: '¿Qué estás atravesando ahora?',
    ...
    sessionTitle: 'Estamos contigo',
    sessionLoading: 'Preparando tu espacio…',
    ...
    crisisMode:
      'Menos presión, más cuidado. Hoy no tienes que rendir.',
    supportMessageTitle: 'Para ti',
    aiPersonalized: 'Personalizado',
    patternTitle: 'Algo que notamos',
    gentleActionsTitle: 'Pasos suaves',
    modulesMore: 'Más herramientas ({{count}})',
    modulesHide: 'Ocultar',
  ...
  frentes: {
    ...
    newProject: 'Nuevo proyecto',
    yourFronts: 'Tus proyectos',
    yourFrontsSub: 'Tus ideas agrupadas por lo que ocupa tu mente',
    newFront: 'Nuevo proyecto',
    chipCountOne: '1 cosa',
    ...
    liveAdjustHint: 'Toca Soltar para revisar cada proyecto — sin prisa.',
  ...
  reorganizeDay: {
    ...
    ellieAdjust: 'Está bien. Ajustamos.',
    whatChanged: '¿Qué ha cambiado?',
    reason: {
      tired: 'Agotada',
      less_time: 'Con poco tiempo',
      new_event: 'Surgió algo importante',
      priorities_changed: 'No pude avanzar hoy',
      more_energy: 'Con más energía',
    },
    reasonSub: {
      tired: 'Necesito ir más despacio',
      less_time: 'Menos horas de las que pensaba',
      new_event: 'Algo nuevo tomó prioridad',
      priorities_changed: 'Quiero replanear con fechas y energía',
      more_energy: 'Quiero aprovechar el impulso de hoy',
    },
    building: 'Preparando una propuesta…',
    mascotThanks: 'Gracias, {{name}}.',
    mascotIntro: 'Con lo que me contaste, esto es lo que haría:',
    ...
    confirmCta: 'Aceptar este plan',
    editDatesCta: 'Déjame editar las fechas',
    editDatesHint: 'Toca un paso para elegir otro día.',
    dayPreviewTitle: 'Así se vería {{day}}',
    dayPreviewEmpty: 'Aún no hay pendientes ese día.',
    moveToDay: 'Mover a',
    openCalendarChip: 'Calendario',
    backToPlan: 'Volver al plan anterior',
    capacityTitle: 'Tiempo de hoy',
    capacitySteps: '{{count}} pasos',
    capacityPlanned: '{{duration}} estimados',
    capacityAvailable: '{{duration}} disponibles',
    capacityOverload:
      'Tu plan suma un poco más de lo que cabe hoy — por eso tiene sentido reorganizar.',
    capacityFit: 'Tu plan encaja en el tiempo que tienes hoy.',
    adjustWeekCta: 'Ajustar mi semana ✨',
  },
} as const;
