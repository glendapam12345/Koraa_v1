export const extEs = {
  ...
  deviceCalendar: {
    ...
    addShort: 'Calendario',
    successTitle: 'Listo',
    successBody: 'La tarea se agregó a tu Calendario.',
    ...
    unavailableBody:
      'Agregar al Calendario del iPhone requiere la versión más reciente de Koraa (build 27 o superior). Actualiza desde TestFlight o la App Store.',
    eventNotes: 'Tarea de Koraa',
    a11y: 'Agregar {{task}} al Calendario del dispositivo',
  },
  redistribute: {
    title: 'Aliviar carga',
    close: 'Cerrar',
  ...
  projects: {
    ...
    inventoryNoFocus: '{{total}} pendientes guardados · ve a Sentir para elegir focos en Hoy',
    ...
    inventoryGoFeel: 'Ir a Sentir',
    inventoryGoFeelA11y: 'Ir a Sentir para elegir focos del día',
  ...
  quickRecheck: {
    ...
    stepHint: 'Un minuto · 4 respuestas rápidas',
